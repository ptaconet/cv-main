...
- **R : confirmé** (voir [dépôt GitHub](https://github.com/ptaconet)). Libraires types maîtrisées : développement de librairies R ([`usethis`](https://cran.r-project.org/web/packages/usethis/index.html)), manipulation de données tabulaires ([`dplyr`](https://cran.r-project.org/web/packages/dplyr/index.html), [`tidyr`](https://cran.r-project.org/web/packages/tidyr/index.html), [`lubridate`](https://cran.r-project.org/web/packages/lubridate/index.html), [`stringr`](https://cran.r-project.org/web/packages/stringr/index.html), [`tibble`](https://cran.r-project.org/web/packages/tibble/index.html), [`data.table`](https://cran.r-project.org/web/packages/data.table/index.html)), manipulation de données spatiales ([`sf`](https://cran.r-project.org/web/packages/sf/index.html), [`terra`](https://cran.r-project.org/web/packages/terra/index.html), [`stars`](https://cran.r-project.org/web/packages/stars/index.html)), visualisation ([`ggplot2`](https://cran.r-project.org/web/packages/ggplot2/index.html), [`patchwork`](https://cran.r-project.org/web/packages/patchwork/index.html), [`GGally`](https://cran.r-project.org/web/packages/GGally/index.html)), cartographie ([`ggmap`](https://cran.r-project.org/web/packages/ggmap/index.html), [`tmap`](https://cran.r-project.org/web/packages/tmap/index.html)), programmation fonctionnelle ([`purrr`](https://cran.r-project.org/web/packages/purrr/index.html)), gestion de bases de données ([`DBI`](https://cran.r-project.org/web/packages/DBI/index.html)), biostatistiques ([`glmmTMB`](https://cran.r-project.org/web/packages/glmmTMB/index.html)), machine learning ([`caret`](https://cran.r-project.org/web/packages/caret/index.html), [`ranger`](https://cran.r-project.org/web/packages/ranger/index.html), [`randomForest`](https://cran.r-project.org/web/packages/randomForest/index.html)), *interpretable machine learning* ([`iml`](https://cran.r-project.org/web/packages/iml/index.html), [`pdp`](https://cran.r-project.org/web/packages/pdp/index.html), [`vip`](https://cran.r-project.org/web/packages/vip/index.html)), programmation lettrée ([`bookdown`](https://cran.r-project.org/web/packages/bookdown/index.html)), parallélisation ([`furrr`](https://cran.r-project.org/web/packages/furrr/index.html)).
- R Markdown : confirmé (voir [manuscrit de thèse](https://github.com/ptaconet/phd_thesis) et [supports pédagogiques rédigés](https://doi.org/10.5281/zenodo.7380029))
...
- Conception et développement de bases de données géographiques et d'infrastructures de données spatiales dans le domaine de la bio-écologie et de l'épidémiologie (ex: PostgreSQL + PostGIS)
...
- Cartographie (QGIS, R)
- Télédétection, cubes spatio-temporels d'observation de la Terre (OTB, SAGA, GRASS GIS, R)
